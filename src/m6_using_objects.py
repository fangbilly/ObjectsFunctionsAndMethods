...
def two_circles():
    ...
    center_point = rg.Point(300, 500)
    radius = 50
    circle = rg.Circle(center_point, radius)
    circle.fill_color = 'green'
    circle.attach_to(window)

    center_point2 = rg.Point(700, 500)
    radius2 = 100
...
def circle_and_rectangle():
    ...
    point1 = rg.Point(600, 150)
    point2 = rg.Point(700, 50)
...
def lines():
    ...
    # ------------------------------------------------------------------
    window = rg.RoseWindow(1000, 1000)
    point1 = rg.Point(1, 100)
    point2 = rg.Point(500, 200)
    line1 = rg.Line(point1, point2)
    line1.attach_to(window)

    point3 = rg.Point(1, 600)
    point4 = rg.Point(500, 400)
